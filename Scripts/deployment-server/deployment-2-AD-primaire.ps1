...
New-SmbShare -Name "Dev" -Path "C:\Dev" -FullAccess "EXIA\GRP_Admin","EXIA\Dev\GRP_devResponsables" -ReadAccess "EXIA\Dev\GRP_dev" -WriteAccess "EXIA\Dev\GRP_dev" -EncryptData $True
...
New-SmbShare -Name "Stagiaire" -Path "C:\Stagiaire" -FullAccess "EXIA\GRP_Admin","EXIA\Stagiaire\GRP_stagaireResponsables" -ReadAccess "Exia\Stagiaire\GRP_stagaire" -WriteAccess "Exia\GRP_stagaires" -EncryptData $True
